...
-- ========================================
-- 動画（cf_video_id はダミー、duration は開発用にBig Buck Bunny相当 ≒ 596秒）
-- ========================================
INSERT INTO videos (category_id, title, description, cf_video_id, duration, display_order, is_published) VALUES
  (1, 'コンプライアンス基礎研修', 'コンプライアンスの基本的な考え方と重要性について学びます。', 'dummy-cf-id-001',596, 1, true),
  (1, '内部通報制度の理解', '内部通報制度の仕組みと利用方法を解説します。', 'dummy-cf-id-002', 596, 2, true),
  (2, '情報セキュリティ入門', 'パスワード管理やフィッシング対策の基礎を学びます。', 'dummy-cf-id-003', 596, 1, true),
  (2, 'リモートワークのセキュリティ', '在宅勤務時のセキュリティ対策を解説します。', 'dummy-cf-id-004', 596, 2, true),
  (3, 'ハラスメント防止研修', '職場におけるハラスメントの定義と防止策を学びます。', 'dummy-cf-id-005', 596, 1, true),
  (4, 'ビジネスマナー基礎', '社会人として必要な基本マナーを習得します。', 'dummy-cf-id-006', 596, 1, true),
  (4, '報連相の基本', '報告・連絡・相談の重要性と実践方法を学びます。', 'dummy-cf-id-007', 596, 2, false)
ON CONFLICT DO NOTHING;
