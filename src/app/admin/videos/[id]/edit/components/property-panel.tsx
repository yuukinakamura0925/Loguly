...
export function PropertyPanel({
  ...
  return (
    <div className="h-full flex">
      {/* Left: Label */}
      <div className="w-24 flex-shrink-0 px-3 py-3 border-r border-slate-200 bg-slate-50 flex items-start">
        <h2 className="text-sm font-medium text-slate-700">プロパティ</h2>
      </div>
      ...
      <div className="flex-1 overflow-auto p-4">
        ...
        {isCreatingAudio && (
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              <h3 className="text-sm font-medium text-teal-600">読み上げを作成</h3>
              <button
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full px-3 py-2 bg-slate-50 border border-slate-200 rounded text-slate-900 text-sm resize-none focus:ring-2 focus:ring-teal-500 focus:border-transparent placeholder-slate-400 disabled:opacity-50"
              />
            ...
            {draftStatus === "generating" && (
              <div className="flex items-center justify-center gap-2 py-4 text-teal-600">
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 bg-slate-50 border border-slate-200 rounded text-slate-900 text-sm font-mono focus:ring-2 focus:ring-teal-500 focus:border-transparent"
                  />
                </div>
        ...
        {!isCreatingAudio && selectedSubtitle && (
          <div className="flex gap-4 items-start">
            <div className="flex items-center gap-2">
              <span className="text-sm font-medium text-amber-600">字幕</span>
            </div>
            ...
            <div className="flex-1">
              ...
              <input
                ...
                className="w-full px-3 py-1.5 bg-slate-50 border border-slate-200 rounded text-slate-900 text-sm focus:ring-2 focus:ring-amber-500 focus:border-transparent"
              />
            </div>
            ...
            <div className="flex gap-2">
              <div>
                ...
                <input
                  ...
                  className="w-24 px-2 py-1.5 bg-slate-50 border border-slate-200 rounded text-slate-900 text-sm font-mono focus:ring-2 focus:ring-amber-500 focus:border-transparent"
                />
              </div>
              <div>
            ...
            <button
              ...
              className="text-xs text-red-500 hover:text-red-600 mt-5"
            >
              削除
            </button>
          </div>
        ...
        {!isCreatingAudio && selectedAudio && (
          <div className="flex gap-4 items-start">
            <div className="flex items-center gap-2">
              <span className="text-sm font-medium text-teal-600">読み上げ</span>
            </div>
            ...
            <div className="flex-1">
              ...
              <input
                ...
                placeholder="読み上げるテキストを入力..."
                className="w-full px-3 py-1.5 bg-slate-50 border border-slate-200 rounded text-slate-900 text-sm focus:ring-2 focus:ring-teal-500 focus:border-transparent placeholder-slate-400"
              />
            </div>
            ...
            <div>
              ...
              <input
                ...
                className="w-24 px-2 py-1.5 bg-slate-50 border border-slate-200 rounded text-slate-900 text-sm font-mono focus:ring-2 focus:ring-teal-500 focus:border-transparent"
              />
            </div>
            ...
            {selectedAudio.status === "ready" && (
              <div className="flex items-end gap-2">
                ...
                <span className="text-xs text-slate-500 mb-1">{(selectedAudio.duration / 1000).toFixed(1)}秒</span>
              </div>
            )}
            ...
            <button
              ...
              className="px-3 py-1.5 bg-teal-500 text-white text-xs rounded hover:bg-teal-600 disabled:opacity-50 disabled:cursor-not-allowed transition-colors flex items-center gap-1 mt-5"
            >
              {generatingAudio ? (
        ...
        {!isCreatingAudio && !selectedSubtitle && !selectedAudio && (
          <div className="flex items-center gap-3 text-slate-400">
            ...
            <p className="text-sm">タイムライン上の字幕や音声クリップを選択して編集</p>
          </div>
        )}
      </div>
    </div>
