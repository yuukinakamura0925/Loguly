...
export default async function DashboardPage() {
  ...
  type DashboardVideo = { id: number; category_id: number; title: string; description: string | null; duration: number; display_order: number; orgDisplayOrder: number | null; label: string | null; labelColor: string | null };
  const videos: DashboardVideo[] = (licensesResult?.data || [])
    ...
    .map((l: any) => {
      ...
      return {
        ...
        labelColor: (l.label_color as string | null) ?? null,
      };
    })
